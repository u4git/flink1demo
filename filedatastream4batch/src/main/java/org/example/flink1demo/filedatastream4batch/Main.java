package org.example.flink1demo.filedatastream4batch;
...
public class Main {
    public static void main(String[] args) throws Exception {
        System.out.println("flink1demo filedatastream4batch...");
        ...
        // 读取数据
        FileSource fileSource = FileSource.forRecordStreamFormat(new TextLineInputFormat(), new Path("words.txt")).build();

        DataStreamSource<String> lines = env.fromSource(fileSource, WatermarkStrategy.noWatermarks(), "Text File Source");
        ...
        // 执行
        env.execute("filedatastream4batch");
